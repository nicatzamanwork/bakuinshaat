  ...
  const faqs = [
    {
      ...
      answer: 'Armatur üçün minimum sifariş həcmi 10 tondur. Borular üçün isə 5 ton. Xüsusi hallarda fərdi yanaşma tətbiq edilir. Topdan sifarişlərdə xüsusi endirimlər mövcuddur.',
    },
    {
      question: 'Çatdırılma nə qədər vaxt aparır?',
      answer: 'Standart məhsullar üçün çatdırılma müddəti 5-7 iş günüdür. Böyük həcmli sifarişlər və ya xüsusi tələblər üçün müddət 10-15 iş günü ola bilər. Bakı daxilində çatdırılma pulsuzdur.',
    },
    {
      question: 'Hansı ödəniş üsulları mövcuddur?',
      answer: 'Bank köçürməsi, nağd ödəniş, və müqavilə əsasında kredit xətti. Daimi müştərilər üçün təxirəsalma şərtləri də mövcuddur. B2B müştərilərə xüsusi ödəniş şərtləri tətbiq olunur.',
    },
    {
      question: 'Məhsullara zəmanət verilirmi?',
      answer: 'Bəli, bütün məhsullarımıza beynəlxalq standartlara uyğunluq zəmanəti verilir. Hər partiyaya test sertifikatları və keyfiyyət göstəriciləri əlavə olunur. İstehsal qüsuru olduqda tam əvəz etmə həyata keçirilir.',
    },
    {
      question: 'İxrac sifarişləri qəbul edirsinizmi?',
      answer: 'Bəli, məhsullarımız Gürcüstan, Türkiyə, Rusiya və Mərkəzi Asiya ölkələrinə ixrac olunur. Bütün lazımi sənədlərin hazırlanması və logistikada dəstək təmin edirik.',
    },
    {
      question: 'Xüsusi ölçülərdə sifariş vermək mümkündürmü?',
      answer: 'Xüsusi tələblərə uyğun istehsal xidməti göstəririk. Fərdi ölçülər, xüsusi texniki xüsusiyyətlər və sair. Texniki departamentimizlə əlaqə saxlayaraq detal məlumat əldə edə bilərsiniz.',
    },
    {
      question: 'Zavodu ziyarət etmək mümkündürmü?',
      answer: 'Bəli, müştərilərimiz və potensial partnyorlar üçün zavod turları təşkil edirik. Görüş təyin etmək üçün əvvəlcədən əlaqə saxlamalısınız. İstehsal prosesləri və avadanlıqları görə bilərsiniz.',
    },
    {
      question: 'Texniki məsləhət xidməti varmı?',
      answer: 'Bəli, mühəndis-texniki işçilərimiz layihələriniz üçün pulsuz məsləhət xidməti göstərir. Material seçimi, hesablamalar və texniki spesifikasiyalar üzrə dəstək təmin edirik.',
    },
  ];
          ...
          <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-sm space-y-1">
                    ...
                    <div className="text-blue-900">sales@metalsteel.az (B2B)</div>
            ...
            <div className="mt-8 p-6 bg-blue-50 border border-blue-100">
              ...
              <p className="text-gray-600 text-sm">
                Topdan satış, ixrac və xüsusi sifarişlər üçün B2B departamentimizlə 
                bilavasitə əlaqə saxlayın: <strong>sales@metalsteel.az</strong>
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 text-center p-8 bg-white border border-gray-200">
              <h3 className="text-gray-900 mb-3">Sualınızın cavabını tapmadınız?</h3>
              <p className="text-gray-600 mb-6">
                Bizə yazın və ya zəng edin, komandamız sizə kömək etməkdən məmnun olacaq.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Button 
                  onClick={() => window.location.href = 'mailto:info@metalsteel.az'}
                  variant="outline"
                >
