import { Target, Eye, Users, Cog, Award, TrendingUp, Trophy, Zap, Globe, Briefcase } from 'lucide-react';
...
const timeline = [
  {
    year: '2005',
    title: 'Şirkətin təsis edilməsi',
    description: 'Kiçik armatur istehsalı müəssisəsi olaraq fəaliyyətə başladıq',
  },
  {
    year: '2008',
    title: 'İlk beynəlxalq sertifikat',
    description: 'ISO 9001 keyfiyyət idarəetmə sistemi sertifikatı əldə edildi',
  },
  {
    year: '2012',
    title: 'Zavod genişləndirilməsi',
    description: 'İstehsal sahəsi 35,000 m²-ə çatdırıldı, yeni avadanlıqlar quraşdırıldı',
  },
  {
    year: '2015',
    title: 'Boru istehsalı başlandı',
    description: 'Elektrik qaynaq boru xətti istifadəyə verildi',
  },
  {
    year: '2018',
    title: 'İxrac bazarlarına çıxış',
    description: 'Məhsullar Gürcüstan, Türkiyə və Rusiyaya ixrac edilməyə başlandı',
  },
  {
    year: '2020',
    title: 'Fasiləsiz tökükxana',
    description: 'Müasir CCM texnologiyası ilə avadanlıq quraşdırıldı',
  },
  {
    year: '2023',
    title: '250,000 ton/il güc',
    description: 'İstehsal gücü maksimal həddə çatdırıldı, 500+ işçi çalışır',
  },
];
...
const values = [
  {
    icon: Award,
    title: 'Keyfiyyət',
    description: 'Hər mərhələdə yüksək standartlara riayət və davamlı təkmilləşdirmə',
  },
  {
    icon: Zap,
    title: 'İnnovasiya',
    description: 'Yeni texnologiyalara investisiya və proseslərin modernləşdirilməsi',
  },
  {
    icon: Users,
    title: 'Komanda',
      ...
      <section className="bg-gradient-to-br from-blue-900 to-blue-800 text-white py-20 lg:py-32">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6">
              Metal Sənayesində Lider
            </h1>
            <p className="text-blue-100 text-lg">
              2005-ci ildən etibarən Azərbaycanda və MDB məkanında 
              yüksək keyfiyyətli metal məhsulların istehsalı və satışı.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <h2 className="text-gray-900 mb-6">
              18 İllik Təcrübə və İnkişaf
            </h2>
            <div className="space-y-6 text-gray-600">
              <p>
                Metal Steel Industrial Group 2005-ci ildə kiçik bir armatur 
                istehsalı müəssisəsi olaraq fəaliyyətə başlamışdır. Müasir 
                texnologiyalara investisiya və beynəlxalq standartlara uyğunluq 
                sayəsində sürətlə böyümüşük.
              </p>
              <p>
                Bu gün biz regionun ən böyük metal məhsul istehsalçılarından 
                biriyik. 75,000 m² istehsal sahəsində, 500-dən çox işçi ilə 
                ildə 250,000 ton məhsul istehsal edirik.
              </p>
              <p>
                Məhsullarımız Azərbaycan, Gürcüstan, Türkiyə, Rusiya və 
                Mərkəzi Asiya ölkələrinə ixrac olunur. Biz sadəcə məhsul 
                istehsal etmirik, həm də tikinti və infrastruktur layihələrinin 
                uğuruna töhfə veririk.
              </p>
              <p>
                Komandamız daim inkişaf edir, texnologiyalarımız yenilənir və 
                keyfiyyət standartlarımız artır. Məqsədimiz - regionun aparıcı 
                metal istehsalçısı kimi mövqeyimizi möhkəmləndirmək və 
                beynəlxalq bazarda tanınan brend olmaqdır.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              2005-ci ildən bu günə qədər keçdiyimiz yol və əldə etdiyimiz nailiyyətlər
            </p>
          </div>
      ...
      <section className="container mx-auto px-6 lg:px-12 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="bg-white p-12 border border-gray-200">
            <Target className="w-12 h-12 text-blue-900 mb-6" strokeWidth={1.5} />
          ...
          <div className="bg-white p-12 border border-gray-200">
            ...
            <p className="text-gray-600 mb-6">
              ...
              bazarda tanınan marka olmaq. İnnovasiya və davamlı inkişaf 
              yolu ilə ixrac həcmini artırmaq, yeni məhsul xətləri əlavə 
              etmək və sənaye 4.0 texnologiyalarını tətbiq etmək.
            </p>
            <p className="text-gray-600">
              2030-cu ilə qədər istehsal gücünü 500,000 ton/ilə çatdırmaq, 
              yeni ixrac bazarları əldə etmək və regionun ən texnoloji cəhətdən 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, idx) => (
              <div key={idx} className="bg-white p-8 border border-gray-200">
                <value.icon className="w-10 h-10 text-blue-900 mb-4" strokeWidth={1.5} />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {management.map((person) => (
            <div key={person.id} className="text-center">
              ...
              <div className="text-sm text-blue-900 mb-2">{person.position}</div>
      ...
      <section className="bg-white py-20 lg:py-32">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Keyfiyyətimiz və töhfələrimiz dövlət və peşə təşkilatları tərəfindən qiymətləndirilir
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {achievements.map((achievement, idx) => (
              <div key={idx} className="bg-gray-50 p-8 border border-gray-200 text-center">
                <Trophy className="w-12 h-12 text-blue-900 mx-auto mb-4" strokeWidth={1.5} />
                <div className="text-2xl text-blue-900 mb-2">{achievement.year}</div>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20 lg:py-32">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <h2 className="mb-6">
              Yüksək Texnoloji İmkanlar
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="flex items-start gap-4">
              <Award className="w-8 h-8 text-blue-400 flex-shrink-0 mt-1" strokeWidth={1.5} />
              <div>
                <h3 className="mb-2">Sertifikatlar</h3>
                <p className="text-gray-300 text-sm">
                  ISO 9001:2015, ISO 14001:2015, OHSAS 18001, CE Marking və digər 
                  beynəlxalq sertifikatlar
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <TrendingUp className="w-8 h-8 text-blue-400 flex-shrink-0 mt-1" strokeWidth={1.5} />
              <div>
                <h3 className="mb-2">İllik Artım</h3>
                <p className="text-gray-300 text-sm">
                  İstehsal həcmi son 5 ildə 35% artım göstərib, gələcək planlar daha 
                  ambisiozludur
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <Cog className="w-8 h-8 text-blue-400 flex-shrink-0 mt-1" strokeWidth={1.5} />
              <div>
                <h3 className="mb-2">Texnoloji Baza</h3>
                <p className="text-gray-300 text-sm">
                  Avropa və Yaponiya istehsalı müasir avadanlıqlar, avtomatlaşdırılmış 
                  istehsal xətləri
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <Users className="w-8 h-8 text-blue-400 flex-shrink-0 mt-1" strokeWidth={1.5} />
              <div>
                <h3 className="mb-2">Kadr Potensialı</h3>
                <p className="text-gray-300 text-sm">
                  500+ işçi, o cümlədən 80+ mühəndis və texniki mütəxəssis, davamlı 
                  təlim proqramları
                </p>
              </div>
            </div>
